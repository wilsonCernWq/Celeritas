...
{
    objHandle = (void*)(new LRAM_Net_SONtcpClient());
}


void getServerObj(void*& objHandle)
{
    objHandle = (void*)(new LRAM_Net_SONtcpServer());
}


void delClientObj(void*& objHandle)
{
    LRAM_Net_SONtcpClient *obj = (LRAM_Net_SONtcpClient *)objHandle;
    delete obj;
    obj = 0;
}
...
{
    LRAM_Net_SONtcpServer *obj = (LRAM_Net_SONtcpServer *)objHandle;
    delete obj;
    obj = 0;
}
