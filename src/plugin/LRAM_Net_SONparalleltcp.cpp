#include "LRAM_Net_SONparalleltcp.h"
...
void getClientObj(void*& objHandle)
{
    objHandle = (void*)(new LRAM_Net_SONparalleltcpClient());
}


void getServerObj(void*& objHandle)
{
    objHandle = (void*)(new LRAM_Net_SONparalleltcpServer());
}


void delClientObj(void*& objHandle)
{
    LRAM_Net_SONparalleltcpClient *obj = 
							(LRAM_Net_SONparalleltcpClient *)objHandle;
    delete obj;
    obj = 0;
}


void delServerObj(void*& objHandle)
{
    LRAM_Net_SONparalleltcpServer *obj = 
							(LRAM_Net_SONparalleltcpServer *)objHandle;
    delete obj;
    obj = 0;
}
